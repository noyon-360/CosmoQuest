                ...
                SliverToBoxAdapter(
                  child: Container(
                    ...
                    child: TabBarView(
                      controller: _tabController,
                      children: [
                        achievementsTab(viewModel), // For the achievements tab, keep it as is.
                        CustomScrollView(
                          slivers: [
                            activityTab(viewModel), // Use the SliverList-based activityTab here.
                          ],
                        ),
                      ],
                    ),
    ...
    return SliverList(
      delegate: SliverChildBuilderDelegate(
          ...
          if (viewModel.userRatings.length > level.levelNumber - 1) {
            levelRating = viewModel.userRatings[level.levelNumber - 1];
          }

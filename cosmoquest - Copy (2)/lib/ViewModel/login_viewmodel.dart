...
class LoginViewModel extends ChangeNotifier {
  ...
  Future<void> resetPassword(BuildContext context) async {
    ...
    try {
      ...
      SnackBarUtil.showSnackbar(context, "Password reset email sent. Please check your inbox.");
    } on FirebaseAuthException catch (e) {
      print("Error: $e");
      SnackBarUtil.showSnackbar(context, "Failed to send password reset email. Please try again.");
    }
  }
